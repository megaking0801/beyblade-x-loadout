...
> 2026-09-20 續作：已改為台灣競技向推薦。`src/domain/competitiveMeta.ts` 將台灣 Catalog 的完整 3on3 賽果與版本化全球 Top Cut 快照合併，3on3 候選不再只取「新手」排序，下一包推薦只在能改善合法競技 3on3 時入榜，配裝器會揭露台灣優先／全球補樣本、日期與來源。尚未 commit／push／部署；驗證為 435 Vitest passed、typecheck、build passed。後續若更新 Meta，禁止從零件 T 表推導完整配置戰績；未有來源的分母、Top 4、冠軍數必須維持 0。
